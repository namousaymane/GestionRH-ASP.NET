    ...
    public class RegisterModel : PageModel
    {
        ...
        private Utilisateur CreateUser()
        {
            try
            {
                ...
                // Initialisation des valeurs par défaut pour éviter les erreurs SQL
                nouvelEmploye.Poste = "À définir";
                nouvelEmploye.Salaire = 0;
                nouvelEmploye.Role = "Employe";
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Employe)}'. " +
                    $"Ensure that '{nameof(Employe)}' is not an abstract class and has a parameterless constructor.");
            }
        }
